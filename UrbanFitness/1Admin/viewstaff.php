		...
		<main>
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li><i class='bx bx-chevron-right'></i></li>
						<li>
							<a class="active" href="viewstaff.php">View staff</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div id="content">
				<div id="content-header">
					<br>
					<h1 class="text-center" style="text-align:center; font-size: 40px;">GYM's Staff List <i class="fas fa-briefcase"></i></h1>
				</div>
						...
						<div class="span12">
							...
							<div class='widget-box'>
								<div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
									<h5 style="margin:15px; font-size: 16px;">Staff table</h5>
								</div>
              ...
              <thead>
                ...
                <td><div class='text-center'><a href='editStaffForm.php?id=" . $row['staffid'] . "'><i class='fas fa-edit' style='color:#28b779'></i> Edit |</a> <a href='deleteStaff.php?id=" . $row['staffid'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
                </tr>
