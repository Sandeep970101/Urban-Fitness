...
<head>
	...
	<!-- My CSS -->
	<link rel="stylesheet" href="css/addmb.css">
									...
									<div class="widget-content nopadding">
										...
										<form action="addmbFunction.php" id="addmbForm" method="POST">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="email" class="span11" name="email" id="email" placeholder="Email" required />
												</div><br>
											</div>
											<div class="control-group">
												...
												<div class="controls">
													...
													<span class="help-block">Note: The given information will create an
														account for
									...
									<div class="widget-content nopadding">
										<div class="form-horizontal">
											<div class="control-group">
												...
												<div class="controls">
													<input type="number" class="span11" id="mask-phone" name="contact" placeholder="9876543210" required class="span8 mask text">
