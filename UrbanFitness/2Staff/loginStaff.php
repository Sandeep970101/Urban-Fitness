        ...
        <div class="login_box">
            <div class="left">
                ...
                <div class="contact">
                    ...
                    <form action="staffLoginFunction.php" method="POST" id="staffLoginForm">
                        <h3>Login - Staff</h3>
                        <input type="text" placeholder="Email" name="email" id="txtUser" required>
                        <input type="password" placeholder="Password" name="password" id="txtPassword" autocomplete="off" required>
                        <button class="submit" type="submit" title="Log In" name="staffLoginBtn" onclick="Validation()" type="submit">Sign in</button>
                    </form>
                </div>
            </div>
            <div class="right">
...
<script>
    function Validation() {
        email = document.forms["staffLoginForm"]["email"].value;
        password = document.forms["staffLoginForm"]["password"].value;
