...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="css/deletegym.css">
        ...
        <main>
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right'></i></li>
                        <li>
                            <a class="active" href="deletegym.php">Delete equipment details</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div id="content2">
                <div id="content2-header">
                    <br>
                    <h1 class="text-center" style="text-align:center; font-size: 40px;">Remove Gym's Equipment <i class="fas fa-cogs"></i></h1>
                </div>
              ...
              <thead>
                ...
                <td><div class='text-center'><a href='deletegymReq.php?id=" . $row['eqpid'] . "' style='color:#F66;'><i class='fas fa-trash'></i> Remove</a></div></td>
