...
<body>
    ...
    <section id="content">
        ...
        <nav>
            ...
            <a class="nav-link">Welcome to Urban Fitness!</a>
        </nav>
        <!-- NAVBAR -->
        <section id="content2">
                ...
                while ($row = mysqli_fetch_array($result)) { ?>
                    ...
                    <?php if ($row['reminder'] == '1') { ?>
                        ...
                        <div class="alert alert-danger" role="alert" style="margin:18px;">
                            ...
                            <h4>This is to notify you that your current membership program is going to expire soon. Please clear
                                up your payments before your due dates. <br>IT IS IMPORTANT THAT YOU CLEAR YOUR DUES ON TIME IN
                                ORDER TO AVOID SERVICE DISRUPTIONS.</h4><br>
                            <hr>
                            <p class="mb-0">We value you as our customer and look forward to continue serving you in the future.
                            </p>
                        </div>
