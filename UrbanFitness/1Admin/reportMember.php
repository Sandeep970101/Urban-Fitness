...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="css/progressmb.css">
        ...
        <main>
            ...
            <div id="content2">
                <div id="content2-header">
                    <br>
                    <h1 class="text-center" style="text-align:center; font-size: 40px;">View Reports <i class="fas fa-file"></i></h1>
                </div>
                        ...
                        <div class="span12">
                            ...
                            <div class='widget-box'>
                                ...
                                <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
                                    <h5 style="margin:15px; font-size: 16px;">Report Section</h5>
                                </div>
                  ...
                  <th>Action</th>
                                    ...
                                    while ($row = mysqli_fetch_array($result)) { ?>
                                        ...
                                        <tbody>
                                            ...
                                            <td>
                                                <div class='text-center'><a href="reportMemberView.php?id= <?php echo $row['user_id'] ?>"><i class="fas fa-file"></i> View Report</a></div>
                                            </td>
