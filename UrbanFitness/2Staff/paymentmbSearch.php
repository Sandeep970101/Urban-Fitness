...
<head>
    ...
    <!-- My CSS -->
    <link rel="stylesheet" href="css/paymentmb.css">
                        ...
                        <div class="span12">
                            ...
                            <div class='widget-box'>
                                <div class='widget-title'> <span class='icon'> <i class='fas fa-th'></i> </span>
                                    <h3 style="margin:25px;">Member's Payment table</h3>
                                    <form id="custom-search-form" style="margin:25px;" role="search" method="POST" action="paymentmbSearch.php" class="form-search form-horizontal pull-right">
